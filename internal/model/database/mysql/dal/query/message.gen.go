...
func (m *message) updateTableName(table string) *message {
	...
	m.RecipientID = field.NewString(table, "recipient_id")
...
func (m *message) fillFieldMap() {
	...
	m.fieldMap["recipient_id"] = m.RecipientID
...
type IMessageDo interface {
	...
	Unscoped() IMessageDo
	Create(values ...*sqlmodel.Message) error
	CreateInBatches(values []*sqlmodel.Message, batchSize int) error
	Save(values ...*sqlmodel.Message) error
	First() (*sqlmodel.Message, error)
	Take() (*sqlmodel.Message, error)
	Last() (*sqlmodel.Message, error)
	Find() ([]*sqlmodel.Message, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlmodel.Message, err error)
	FindInBatches(result *[]*sqlmodel.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*sqlmodel.Message) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*sqlmodel.Message, error)
	FirstOrCreate() (*sqlmodel.Message, error)
	FindByPage(offset int, limit int) (result []*sqlmodel.Message, count int64, err error)
...
func (m messageDo) Create(values ...*sqlmodel.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) CreateInBatches(values []*sqlmodel.Message, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m messageDo) Save(values ...*sqlmodel.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) First() (*sqlmodel.Message, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*sqlmodel.Message), nil
	}
}

func (m messageDo) Take() (*sqlmodel.Message, error) {
...
func (m messageDo) Last() (*sqlmodel.Message, error) {
...
func (m messageDo) Find() ([]*sqlmodel.Message, error) {
	result, err := m.DO.Find()
	return result.([]*sqlmodel.Message), err
}

func (m messageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlmodel.Message, err error) {
	buf := make([]*sqlmodel.Message, 0, batchSize)
...
func (m messageDo) FindInBatches(result *[]*sqlmodel.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m messageDo) FirstOrInit() (*sqlmodel.Message, error) {
...
func (m messageDo) FirstOrCreate() (*sqlmodel.Message, error) {
...
func (m messageDo) FindByPage(offset int, limit int) (result []*sqlmodel.Message, count int64, err error) {
...
func (m messageDo) Delete(models ...*sqlmodel.Message) (result gen.ResultInfo, err error) {
