...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.categoryDo.UseModel(&sqlmodel.Category{})
...
type ICategoryDo interface {
	...
	Create(values ...*sqlmodel.Category) error
	CreateInBatches(values []*sqlmodel.Category, batchSize int) error
	Save(values ...*sqlmodel.Category) error
	First() (*sqlmodel.Category, error)
	Take() (*sqlmodel.Category, error)
	Last() (*sqlmodel.Category, error)
	Find() ([]*sqlmodel.Category, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlmodel.Category, err error)
	FindInBatches(result *[]*sqlmodel.Category, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*sqlmodel.Category) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*sqlmodel.Category, error)
	FirstOrCreate() (*sqlmodel.Category, error)
	FindByPage(offset int, limit int) (result []*sqlmodel.Category, count int64, err error)
...
func (c categoryDo) Create(values ...*sqlmodel.Category) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) CreateInBatches(values []*sqlmodel.Category, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c categoryDo) Save(values ...*sqlmodel.Category) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) First() (*sqlmodel.Category, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*sqlmodel.Category), nil
	}
}

func (c categoryDo) Take() (*sqlmodel.Category, error) {
...
func (c categoryDo) Last() (*sqlmodel.Category, error) {
...
func (c categoryDo) Find() ([]*sqlmodel.Category, error) {
	result, err := c.DO.Find()
	return result.([]*sqlmodel.Category), err
}

func (c categoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlmodel.Category, err error) {
	buf := make([]*sqlmodel.Category, 0, batchSize)
...
func (c categoryDo) FindInBatches(result *[]*sqlmodel.Category, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c categoryDo) FirstOrInit() (*sqlmodel.Category, error) {
...
func (c categoryDo) FirstOrCreate() (*sqlmodel.Category, error) {
...
func (c categoryDo) FindByPage(offset int, limit int) (result []*sqlmodel.Category, count int64, err error) {
...
func (c categoryDo) Delete(models ...*sqlmodel.Category) (result gen.ResultInfo, err error) {
