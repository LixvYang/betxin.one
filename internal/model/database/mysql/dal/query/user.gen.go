...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&sqlmodel.User{})
...
type IUserDo interface {
	...
	Unscoped() IUserDo
	Create(values ...*sqlmodel.User) error
	CreateInBatches(values []*sqlmodel.User, batchSize int) error
	Save(values ...*sqlmodel.User) error
	First() (*sqlmodel.User, error)
	Take() (*sqlmodel.User, error)
	Last() (*sqlmodel.User, error)
	Find() ([]*sqlmodel.User, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlmodel.User, err error)
	FindInBatches(result *[]*sqlmodel.User, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*sqlmodel.User) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*sqlmodel.User, error)
	FirstOrCreate() (*sqlmodel.User, error)
	FindByPage(offset int, limit int) (result []*sqlmodel.User, count int64, err error)
...
func (u userDo) Create(values ...*sqlmodel.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*sqlmodel.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*sqlmodel.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*sqlmodel.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*sqlmodel.User), nil
	}
}

func (u userDo) Take() (*sqlmodel.User, error) {
...
func (u userDo) Last() (*sqlmodel.User, error) {
...
func (u userDo) Find() ([]*sqlmodel.User, error) {
	result, err := u.DO.Find()
	return result.([]*sqlmodel.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*sqlmodel.User, err error) {
	buf := make([]*sqlmodel.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*sqlmodel.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*sqlmodel.User, error) {
...
func (u userDo) FirstOrCreate() (*sqlmodel.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*sqlmodel.User, count int64, err error) {
...
func (u userDo) Delete(models ...*sqlmodel.User) (result gen.ResultInfo, err error) {
