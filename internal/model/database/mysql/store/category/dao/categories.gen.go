...
func newCategory(db *gorm.DB, opts ...gen.DOOption) category {
	...
	_category.categoryDo.UseModel(&core.Category{})
...
type ICategoryDo interface {
	...
	Create(values ...*core.Category) error
	CreateInBatches(values []*core.Category, batchSize int) error
	Save(values ...*core.Category) error
	First() (*core.Category, error)
	Take() (*core.Category, error)
	Last() (*core.Category, error)
	Find() ([]*core.Category, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*core.Category, err error)
	FindInBatches(result *[]*core.Category, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*core.Category) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*core.Category, error)
	FirstOrCreate() (*core.Category, error)
	FindByPage(offset int, limit int) (result []*core.Category, count int64, err error)
	...
	GetCategoryById(ctx context.Context, id int64) (result *core.Category, err error)
	ListCategories(ctx context.Context) (result []*core.Category, err error)
	GetCategoryByName(ctx context.Context, name string) (result *core.Category, err error)
	CreateCategory(ctx context.Context, name string) (err error)
	DeleteCategory(ctx context.Context, name string) (err error)
	UpdateCategory(ctx context.Context, category *core.Category) (err error)
}
...
// VALUES
// (@name);
func (c categoryDo) CreateCategory(ctx context.Context, name string) (err error) {
	var params []interface{}
...
func (c categoryDo) Create(values ...*core.Category) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) CreateInBatches(values []*core.Category, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c categoryDo) Save(values ...*core.Category) error {
	if len(values) == 0 {
		return nil
	}
...
func (c categoryDo) First() (*core.Category, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*core.Category), nil
	}
}

func (c categoryDo) Take() (*core.Category, error) {
...
func (c categoryDo) Last() (*core.Category, error) {
...
func (c categoryDo) Find() ([]*core.Category, error) {
	result, err := c.DO.Find()
	return result.([]*core.Category), err
}

func (c categoryDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*core.Category, err error) {
	buf := make([]*core.Category, 0, batchSize)
...
func (c categoryDo) FindInBatches(result *[]*core.Category, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c categoryDo) FirstOrInit() (*core.Category, error) {
...
func (c categoryDo) FirstOrCreate() (*core.Category, error) {
...
func (c categoryDo) FindByPage(offset int, limit int) (result []*core.Category, count int64, err error) {
...
func (c categoryDo) Delete(models ...*core.Category) (result gen.ResultInfo, err error) {
